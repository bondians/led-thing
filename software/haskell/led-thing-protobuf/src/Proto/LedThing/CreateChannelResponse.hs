...
module Proto.LedThing.CreateChannelResponse (CreateChannelResponse(..)) where
import Prelude ((+), (/))
...
data CreateChannelResponse = CreateChannelResponse{request_id :: !(P'.Maybe P'.Word32), status :: !(P'.Maybe LedThing.ResultStatus),
                                                   status_message :: !(P'.Maybe P'.Utf8)}
                           deriving (Prelude'.Show, Prelude'.Eq, Prelude'.Ord, Prelude'.Typeable, Prelude'.Data, Prelude'.Generic)

instance P'.Mergeable CreateChannelResponse where
  mergeAppend (CreateChannelResponse x'1 x'2 x'3) (CreateChannelResponse y'1 y'2 y'3)
   = CreateChannelResponse (P'.mergeAppend x'1 y'1) (P'.mergeAppend x'2 y'2) (P'.mergeAppend x'3 y'3)

instance P'.Default CreateChannelResponse where
  defaultValue = CreateChannelResponse P'.defaultValue P'.defaultValue P'.defaultValue

instance P'.Wire CreateChannelResponse where
  wireSize ft' self'@(CreateChannelResponse x'1 x'2 x'3)
   = case ft' of
       10 -> calc'Size
  ...
  wirePut ft' self'@(CreateChannelResponse x'1 x'2 x'3)
   = case ft' of
       10 -> put'Fields
       11 -> do
